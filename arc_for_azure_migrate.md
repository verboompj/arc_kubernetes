...
![](https://github.com/verboompj/arc_kubernetes/blob/main/pictures/KQL2.png)

Combining, your imagination is the limit. Example query: https://github.com/verboompj/arc_kubernetes/blob/main/query.kql 
this prduces: 
